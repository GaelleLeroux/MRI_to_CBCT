...
if __name__ == '__main__':
    ...
    input_group.add_argument('--mount_point_cbct', help='Dataset mount directory', type=str, default="/home/luciacev/Documents/Gaelle/Data/MultimodelReg/MRI_to_CBCT/training_CBCT/")    
    input_group.add_argument('--mount_point_mri', help='Dataset mount directory', type=str, default="/home/luciacev/Documents/Gaelle/Data/MultimodelReg/MRI_to_CBCT/training_MRI/")    
    ...
    input_group.add_argument('--train_mri', type=str, default="/home/luciacev/Documents/Gaelle/Data/MultimodelReg/MRI_to_CBCT/training_MRI/train.csv", help='path csv mri train')  
    input_group.add_argument('--test_mri', type=str, default="/home/luciacev/Documents/Gaelle/Data/MultimodelReg/MRI_to_CBCT/training_MRI/test.csv", help='path csv mri test')  
    input_group.add_argument('--val_mri', type=str, default="/home/luciacev/Documents/Gaelle/Data/MultimodelReg/MRI_to_CBCT/training_MRI/valid.csv", help='path csv mri valid')  
    input_group.add_argument('--train_cbct', type=str, default="/home/luciacev/Documents/Gaelle/Data/MultimodelReg/MRI_to_CBCT/training_CBCT/train.csv", help='path csv cbct train')  
    input_group.add_argument('--test_cbct', type=str, default="/home/luciacev/Documents/Gaelle/Data/MultimodelReg/MRI_to_CBCT/training_CBCT/test.csv", help='path csv cbct test')  
    input_group.add_argument('--val_cbct', type=str, default="/home/luciacev/Documents/Gaelle/Data/MultimodelReg/MRI_to_CBCT/training_CBCT/valid.csv", help='path csv cbct valid')  


    output_group = parser.add_argument_group('Output')
    output_group.add_argument('--out', help='Output directory', type=str, default="/home/luciacev/Documents/Gaelle/Data/MultimodelReg/MRI_to_CBCT/output_model/")

    log_group = parser.add_argument_group('Logging')
    log_group.add_argument('--neptune_tags', help='Neptune tags', type=str, nargs="+", default="v1")
